defmodule DigicmsWeb.UserAuthTest do
  use DigicmsWeb.ConnCase, async: true

  alias Digicms.Accounts
  alias DigicmsWeb.UserAuth
  import Digicms.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DigicmsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      DigicmsWeb.Endpoint.subscribe(live_socket_id)
